...
function listMode:Init(selBuildName, subPath)
	...
	self.controls.newPath = new("ButtonControl", {"LEFT",self.controls.new,"RIGHT"}, {8, 0, 90, 20}, "New Path bulid", function()
		main:SetMode("NEWBUILD", false, "Unnamed path")
	end)
	self.controls.newFolder = new("ButtonControl", {"LEFT",self.controls.newPath,"RIGHT"}, {8, 0, 90, 20}, "New Folder", function()
